...
h4(#help-section02). Plugin requirements

yab_article_crossref's  minimum requirements:

* Textpattern 4.x

h4(#help-config03). Configuration
...
h4(#help-section10). Changelog

* v0.1: 2017-02-12
** initial release

h4(#help-section11). Licence
...
h4(#help-section12). Author contact
